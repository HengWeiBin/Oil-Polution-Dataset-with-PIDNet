...
class OilPolution(BaseDataset):
    def __init__(self, 
        ...
        self.class_weights = torch.FloatTensor([0.8373, 0.918, 0.866, 1.0345, 
                                        1.0166, 0.9969,
                                        1.1000, 1.0009, 0.9000, 1.5000, 1.8000 , 1.9000, #our label
                                        0.9754, 1.0489,
    ...
    def __getitem__(self, index):
        ...
        name = item["name"]
        image = cv2.imread(os.path.join(self.root,'oilpolution',item["img"]),
                           cv2.IMREAD_COLOR)
        size = image.shape
        ...
        label = cv2.imread(os.path.join(self.root,'oilpolution',item["label"]),
